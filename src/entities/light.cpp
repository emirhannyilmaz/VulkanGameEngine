...
glm::mat4 Light::createViewMatrix(glm::vec3 center) {
    glm::vec3 direction = glm::normalize(position * -1.0f);
    ...
    viewMatrix = glm::rotate(viewMatrix, pitch * -1.0f, glm::vec3(1.0f, 0.0f, 0.0f));
